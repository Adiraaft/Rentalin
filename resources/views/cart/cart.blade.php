            ...
            <div class="w-full sm:w-3/4 px-10 py-10">
                ...
                <div class="md:flex items-strech py-8 md:py-10 lg:py-8 border-t border-gray-50">
                    <div class="md:w-4/12 2xl:w-1/4 w-full">
                        <img src="{{ asset('image/detail_fuji.png') }}"
                            class="md:block hidden w-full h-full object-center object-cover" alt="fujifilm">
                    </div>
                    <div class="md:pl-3 md:w-8/12 2xl:w-3/4 flex flex-col justify-center">
                        <p class="text-xs leading-3 text-gray-800 md:pt-0 pt-4">RF293</p>
                        <div class="flex items-center justify-between w-full">
                            <p class="text-base font-black leading-none text-gray-800">fujifilm XM5</p>
                        ...
                        <p class="text-xs leading-3 text-gray-600 pt-2">Adi Rangga</p>
                        <p class="text-xs leading-3 text-gray-600 py-4">0857684592838</p>
                        <p class="w-96 text-xs leading-3 text-gray-600">Sleman,Yogyakarta</p>
                        <div class="flex items-center justify-between pt-5">
                            ...
                            <p class="text-base font-black leading-none text-gray-800">Rp. 250,000</p>
                        </div>
                    </div>
                </div>
